    ...
    return (
      <div className="field">
        <form onSubmit={this.handleSubmit} className="white">
          ...
          <button className="btn teal lighten-1 z-depth-2" onClick={this.addLine}>Add Line</button>
          <button className="btn teal lighten-1 z-depth-2" onClick={this.removeLine}> Remove Line</button>
          <hr />
          <div className="row">
            <div className="row">
              {line.map((value, idx) => {
                return (
                  <div key={idx}>
                    ...
                    <Feet onChange={this.onChange} />
                    <Hands onChange={this.onChange} />
          ...
          <div className="row">
            ...
            <button className="btn teal lighten-1 z-depth-2 offset-s6">Create</button>
        </form>
      </div>
    );
  }
